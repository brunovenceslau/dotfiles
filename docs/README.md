...
| Page | Reader | Covers |
| --- | --- | --- |
| [development.md](development.md) | A maintainer | The quality gates and what each proves, `STRICT=1`, CI, the hard rules, common changes such as adding a config or bumping a plugin pin. |
